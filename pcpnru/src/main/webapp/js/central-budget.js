...
var app = angular.module('central-budget', [], function($httpProvider) {
...
app.controller('myCtrl', function($scope, $http,$window) {
	...
	$scope.projectcentral = function() { 
		...
		$http({
	          method: "POST", 
	          url: "ajax_centralbudget.jsp",
	          params:{"projectCode":$scope.project_central.split(' - ')[0],"year":$scope.project_central.split(' - ')[1],"ajax_type":"project_central"},
	          headers: {"Accept-Charset":"charset=utf-8",'Content-Type': 'application/x-www-form-urlencoded;charset=utf-8'}
	...
	$scope.gcostcodecentral = function() { 
		
		$http({
	          method: "POST", 
	          url: "ajax_frombudget.jsp",
	          params:{"projectCode":$scope.project_central.split(' - ')[0],"year":$scope.project_central.split(' - ')[1],"gcostcode":$scope.gcostcode_rock},
	          headers: {"Accept-Charset":"charset=utf-8",'Content-Type': 'application/x-www-form-urlencoded;charset=utf-8'}
