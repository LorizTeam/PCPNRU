...
<%
	...
	if(ajax_type.equals("project")){
		...
		pStmt.close(); 
		conn.close();
	}else if(ajax_type.equals("project_central")){
		
		project_code = request.getParameter("projectCode");
		String year = request.getParameter("year");
		String sql = "";
		
		sql = "SELECT b.gcostcode, b.gcostcode_name "+
				 "from projectplan_detail a INNER JOIN groupcostcode_master b ON (b.gcostcode = a.gcostcode and a.project_code = b.project_code)  "+
	 			 "WHERE a.project_code = '"+project_code+"' and year = '"+year+"' and type_gcostcode = '2' order by b.gcostcode";
