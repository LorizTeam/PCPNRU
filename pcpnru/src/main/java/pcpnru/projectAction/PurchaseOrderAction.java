...
public class PurchaseOrderAction extends ActionSupport {
	...
	public String execute() throws Exception{
		...
		if(pull_detailpr!=null){
			...
			if(ck==true) po_docno = purchaseOrderDB.AddPODT(pre_loadpr, po_docno, year);
		...
		if(savehd!=null){
			...
			if(!quotation_date.equals("")||!quotation_date.equals("-")) quotation_date = dateUtil.CnvToYYYYMMDDEngYear(quotation_date, '-');
