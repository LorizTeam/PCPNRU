...
public class CreateCentralBudgetDB {
	...
	public List GetUnitMasterList(String year) 
	throws Exception { //09-03-2016
		...
		try {
			...
			String sqlStmt = "SELECT year, budget_central " +
			"FROM central_budget " +
			"WHERE "; 
			if(!year.equals("")) sqlStmt = sqlStmt+ "year like '"+year+"%' AND "; 
	...
	public void AddCentralBudget(String year, String amt)  throws Exception{
		...
		String sqlStmt = "INSERT IGNORE INTO central_budget(year,budget_central) " +
		"VALUES ('"+year+"','"+amt+"')";
		//System.out.println(sqlStmt);
		pStmt = conn.createStatement();
	...
	public void UpdateCentralBudget(String year, String amt)  throws Exception{
		...
		String sqlStmt = "UPDATE central_budget set budget_central = '"+amt+"' " +
				"WHERE year = '"+year+"'";
		//System.out.println(sqlStmt); 
		pStmt = conn.createStatement();
		pStmt.executeUpdate(sqlStmt);
	...
	public void DeleteCentralBudget(String year)  throws Exception{
		...
		String sqlStmt = "DELETE From central_budget "+
		"WHERE year = '"+year+"'";
		//System.out.println(sqlStmt);
		pStmt = conn.createStatement();
		pStmt.executeUpdate(sqlStmt);
