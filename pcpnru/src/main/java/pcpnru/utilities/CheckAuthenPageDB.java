...
public class CheckAuthenPageDB {
	...
	public boolean getCheckAuthen(String username,String page_code) throws Exception {
		...
		conn = agent.getConnectMYSql();
	 	...
	 	"a.telephone, a.address, a.position, a.authen_type, a.datetime, b.page_code, b.datetime " +
	 	"FROM " +
	 	"employee a " +
	 	"INNER JOIN authen_page b ON a.authen_type = b.authen_type " +
	 	"WHERE a.username = '"+username+"' and b.page_code = '"+page_code+"' " +
...
public String getProjectCode(String username) throws Exception {
		...
		conn = agent.getConnectMYSql();
	 	...
	 	String sqlStmt = "SELECT a.project_code, a.username, a.`password`, a.`name`, a.lastname, a.dow, a.dob, " +
	 	"a.telephone, a.address, a.position, a.authen_type, a.datetime " +
	 	"FROM " +
	 	"employee a " + 
