...
public class ProductModel extends Create_UpdateModel {
	...
	private String	product_code, product_name, status_id , status_name
					, progroup_id, progroup_name, protype_id, protype_name
					, unit_id, unit_name, brand_id, brand_name;
					
	
	public ProductModel(){}
	
	public ProductModel(String product_code, String product_name, String status_id, String status_name, 
			String progroup_id, String progroup_name, String protype_id,String protype_name,
			String unit_id,String unit_name, String brand_id,String brand_name, 
			String create_by , String create_datetime, String update_by, String update_datetime) {
