...
public class CentralBudgetForm{
	...
	public CentralBudgetForm(String docno, String project_code, String project_name, String year,  String gcostcode, String gcostname, String amt, String frombalance,
			String rocking_budget, String balance, String remark, String docdate, String approve_status) {
		super();
		this.docno = docno;
