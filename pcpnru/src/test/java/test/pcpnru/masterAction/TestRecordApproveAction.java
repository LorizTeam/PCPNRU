...
public class TestRecordApproveAction {
	...
	String docno="00048",title="ขออนุมัติเบิกจ่าย ",date="2016-02-29",month="02",year="2016",thaidate="2559-02-29",thaidateAndformat="29-02-2559";
	...
	public void Select_List_PR_Format_EngDate_TO_THAIDate() throws IOException, Exception{
		...
		Assert.assertEquals("2016-02-29", FormatEngDate);
