...
public class TestPurchaseDB {
	...
	public int InsertPO_HD(String po_docno,String po_year,String docdate,String ref_pr,String ref_prdate,String type
			,String po_offer,int creditday,double penaltype_perday,String ref_quotation,String ref_quotationdate
			,String status,String create_by,String project_code,String approve_by) throws IOException, Exception{
	...
	/*public int InsertPO_HD(String po_docno,String po_year,String docdate,String ref_pr,String ref_prdate,String type
		...
		String sqlQuery = "INSERT IGNORE INTO `po_hd` (`po_docno`, `year`, `docdate`, `ref_pr`, `ref_prdate`,"
				...
				+ "('"+po_docno+"','"+po_year+"','"+docdate+"','"+ref_pr+"','"+ref_prdate+"','"+type+"','"+po_offer+"','"+creditday+"','"+penaltype_perday+"'"
						+ ",'"+ref_quotation+"','"+ref_quotationdate+"','"+status+"','"+create_by+"','"+project_code+"','"+approve_by+"')";
		conn = agent.getConnectMYSql();
		conn.setAutoCommit(false);
		ppStmt = conn.prepareStatement(sqlQuery);
		ppStmt.setString(1, po_docno);
